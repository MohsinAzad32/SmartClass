...
def teacher_screen_register():
    ...
    teacher_username=st.text_input("Enter username",placeholder="James")
    teacher_name=st.text_input("Enter name",placeholder="James Michal")
...
def teacher_screen_login():
    ...
    teacher_username=st.text_input("Enter username",placeholder="Jamesmichal")
